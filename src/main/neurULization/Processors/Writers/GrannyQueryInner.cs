...
namespace ei8.Cortex.Coding.d23.neurULization.Processors.Writers
{
        ...
        where TWriteParameterSet : IDeductiveParameterSet
    {
        ...
        {
            var gqs = grannyWriteProcessor.ReadProcessor.GetQueries((Id23neurULizerWriteOptions)processParameters.Options, writeParametersBuilder(retrievedGrannies.AsEnumerable()));
        ...
        public IGranny RetrieveGranny(Ensemble ensemble, Id23neurULizerOptions options, IEnumerable<IGranny> retrievedGrannies)
        {
            ...
            if (grannyWriteProcessor.ReadProcessor.TryParse(ensemble, (Id23neurULizerWriteOptions)options, writeParametersBuilder(retrievedGrannies), out TGranny granny))
                result = granny;
